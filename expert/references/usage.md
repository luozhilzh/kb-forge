...
If this expert is packaged / distributed separately from the B skill, copy that
file here so the package is self-contained.
...
若本专家包要与 B Skill 分开打包 / 分发，请把那份文件复制到这里，使包自含。
